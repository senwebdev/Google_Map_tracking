...
(function () {
    ...
    function passengerDetailsCtrl($timeout,$rootScope, $scope, $http, MY_CONSTANT,ngDialog,$state,$filter) {
       ...
       // $('input').attr('disabled','disabled');
        ...
        $scope.getPassengerDetails = function () {
            $scope.userRideList=[];
            ...
            $.post(MY_CONSTANT.url + '/user_details', {
                ...
                sort_order: 'DESC'
                    ...
                    $scope.userRideList = d.all_rides;
                    console.log('$scope.userRideList$scope.userRideList', $scope.userRideList);
