...
(function() {
    ...
    function editDriverCtrl($timeout, $rootScope, $scope, $http, MY_CONSTANT, ngDialog, $state, $filter) {
        ...
        if (!localStorage.getItem('driverData')) {
            ...
            var m = $scope.driver.driver_mobile.split('-');
        ...
        $scope.editSave = function() {
            ...
            $http.post(MY_CONSTANT.url + '/edit_driver', form,{headers: {
